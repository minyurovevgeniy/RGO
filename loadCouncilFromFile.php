...
<html>
	...
	<body>
		<div id="header"></div>
		<div id="content">
			<form action="./loadCouncilFromFile_result.php" method="post" enctype="multipart/form-data">
					<?php
						$fields=
							array
							(
								...
								'Номер колонки с временем начала'=>"time_column_number",
								'Номер колонки с временем окончания'=>"end_time_column_number",
								'Номер колонки с описанием'=>"description_column_number",
								'Номер колонки с местом проведения'=>"place_column_number",
								'Требуется очистка? (да/нет)' =>"shouldEmpty"
							);
					?>
					<table>
						<?php
					...
					<input type="file" name="council_file"><br>
