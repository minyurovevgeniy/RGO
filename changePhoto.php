...
<html>
	...
	<body>
		<div id="header"></div>
		<div id="content">
			<h1>Изменение фотографий</h1>
			<form action="./changePhoto_result.php" method="post" enctype="multipart/form-data">
				<table>
					<tr><td>Порядковый номер:</td><td><input type="text" name="photo_id"></td></tr>
