...
<html>
	...
	<body>
		...
		<div id="content">
			...
			<iframe src="./loadEventsFromFile.php"></iframe>
			<div id="timetable">
				<table>
				...
				<div>
					<input class="btn" type="button" id="refreshEventsList" value="Обновить список событий">
					<h3>Выбранное событие</h3>
					<div class="row">
						<div class="col-sm-11 col-md-11 col-sm-11 col-xs-11 choose">
							<b><select id="events-list"></select></b>
						</div>
				...
				<div>
					<div class="row">
						...
						<div class="col-sm-10 col-md-10 col-sm-10 col-xs-10">
							<input id="events-date" type="text" placeholder="Дата" value="">
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-10 col-md-10 col-sm-10 col-xs-10">
							<input id="events-time" type="text" placeholder="Время начала" value="">
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-3 col-md-3 col-sm-3 col-xs-3 add">
							<input class="btn" type="button" id="addEventManually" value="Добавить">
						</div>
						<div class="col-sm-3 col-md-3 col-sm-3 col-xs-3 save">
							<input class="btn" type="button" id="saveEventManually" value="Сохранить">
						</div>
						<div class="col-sm-3 col-md-3 col-sm-3 col-xs-3 delete">
							<input class="btn" type="button" id="deleteEvent" value="Удалить">
						</div>
					</div>
				</div>
			</div>
